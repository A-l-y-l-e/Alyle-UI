...
const ANGULAR_VERSION = pkg.dependencies['@angular/core'];
...
async function updateStackblitzPackage() {
  ...
  pkgOb.dependencies['@angular/common'] = ANGULAR_VERSION;
  pkgOb.dependencies['@angular/core'] = ANGULAR_VERSION;
  pkgOb.dependencies['@angular/compiler'] = ANGULAR_VERSION;
  pkgOb.dependencies['@angular/forms'] = ANGULAR_VERSION;
  pkgOb.dependencies['@angular/platform-browser'] = ANGULAR_VERSION;
  pkgOb.dependencies['@angular/platform-browser-dynamic'] = ANGULAR_VERSION;
  pkgOb.dependencies['@angular/router'] = ANGULAR_VERSION;
  pkgOb.dependencies['@angular/animations'] = ANGULAR_VERSION;
