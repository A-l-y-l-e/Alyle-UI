...
@Component({
  selector: 'input-example-05',
  templateUrl: './input-example-05.component.html',
  styleUrls: ['./input-example-05.component.css']
})
export class InputExample05Component implements OnInit {
