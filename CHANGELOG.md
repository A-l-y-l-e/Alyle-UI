...
* add support for Angular v18 ([#228](https://github.com/A-l-y-l-e/Alyle-UI/issues/228)) ([be59be4](https://github.com/A-l-y-l-e/Alyle-UI/commit/be59be41bb203034187b1e86938b7871af0d45f7))
...
* **core:** use `DOCUMENT` instead of `document` ([287cc23](https://github.com/A-l-y-l-e/Alyle-UI/commit/287cc23e4cf64e0c65fa435abc3ade12dcd68348))
* **grid:** `box-sizing: border-box` is added to all child elements of `<ly-grid item>` ([32927c1](https://github.com/A-l-y-l-e/Alyle-UI/commit/32927c1a0597c9e1d2aa925fea90af70e4a795ed))
* **lyl:** compile keyframe without \`className\` parameter ([da944e4](https://github.com/A-l-y-l-e/Alyle-UI/commit/da944e4016b5d732d82e5db4d2bdb862ee234c83))
* **lyl:** remove comments in CSS generated by `lyl` ([ca97470](https://github.com/A-l-y-l-e/Alyle-UI/commit/ca97470bc968c10cfa40afc91e2a2e54bd1b083d))
* **lyl:** rename parameter `className` to `_className` ([37b1d0e](https://github.com/A-l-y-l-e/Alyle-UI/commit/37b1d0ea982c3b2e888f9fd8642a4c5dff7f1dbd))
* migrate old styles to `lyl` ([fb59f13](https://github.com/A-l-y-l-e/Alyle-UI/commit/fb59f13afa41683dae8d2b0d06143ceb1d115fa1))
* **slider:** fix slider contrast ([a40363f](https://github.com/A-l-y-l-e/Alyle-UI/commit/a40363fc5b32c246be12da4b5daf50b64170873b))


### Features

* **lyl:** improve `lyl` performance ([d177836](https://github.com/A-l-y-l-e/Alyle-UI/commit/d17783696e1456b68db41e6781559de617697557))
* **slider:** remove hammer js ([865de9a](https://github.com/A-l-y-l-e/Alyle-UI/commit/865de9ab0fad41a46ce40e8239ec675ddda26a63))
* support for Angular 12 ([f2ab057](https://github.com/A-l-y-l-e/Alyle-UI/commit/f2ab057e064d46b6133806d6b0d6ac86a50ad56e))
* **theme:** add isRTL method ([daf22fe](https://github.com/A-l-y-l-e/Alyle-UI/commit/daf22febb8934382d8f2feda1a675459eb19d618))
...
* **cropper:** some parts of the image is not draggable ([6873797](https://github.com/A-l-y-l-e/Alyle-UI/commit/6873797acd3734da8eb6d833b527d94957e4294b)), closes [#116](https://github.com/A-l-y-l-e/Alyle-UI/issues/116)
...
* **cropper:** rename `x` to `XOrigin` ([71ca4cd](https://github.com/A-l-y-l-e/Alyle-UI/commit/71ca4cd3a504af4854c138bec82bfe2fe8e253d7))


### Features

* **cropper:** add `left` and `top` to result ([2d0211f](https://github.com/A-l-y-l-e/Alyle-UI/commit/2d0211f5ea46ef4e22776b3323d8092e0887c396))
...
* **style:** allow `@global` in any nested style ([b6db615](https://github.com/A-l-y-l-e/Alyle-UI/commit/b6db615))
